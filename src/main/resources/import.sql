...
INSERT INTO sensor_type(type_code, type_dtl, type_name, type_color_code, display, unit) values('T', '온도센서', '온도', '#f2b345', 1, "ºC");
INSERT INTO sensor_type(type_code, type_dtl, type_name, type_color_code, display, unit) values('H', '습도센서', '습도', '#249e53', 2 , "%");
INSERT INTO sensor_type(type_code, type_dtl, type_name, type_color_code, display, unit) values('D', '분진센서', '분진', '#3848bc', 3, "mg/m^3");
INSERT INTO sensor_type(type_code, type_dtl, type_name, type_color_code, display, unit) values('G', '가스센서', '가스', '#622aa7', 4, "ppm");
INSERT INTO sensor_type(type_code, type_dtl, type_name, type_color_code, display, unit) values('CC', '이산화탄소 센서', 'CO2', '#9e9e9e', 0, "ppm");
INSERT INTO sensor_type(type_code, type_dtl, type_name, type_color_code, display, unit) values('C', '일산화탄소 센서', 'CO', '#795548',0, "ppm");
